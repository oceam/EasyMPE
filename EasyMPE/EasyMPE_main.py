...
class MainWindow(QWidget):
        ...
        while (1):
            ...
            if key == ord('o'): 
                ...
                if len(self.coord) < 3:
                    ...
                    self.time_binary = timedelta(seconds=end_time - start_time)
                    print('Binary : ' + str(self.time_binary))
    ...
    def application(self):
        ...
        if self.radio_horizontal.isChecked() == False and self.radio_vertical.isChecked() == False:
            ...
            end_time = time.monotonic()
            self.time_MPE = timedelta(seconds=end_time - start_time)
            print('MPE : ' + str(self.time_MPE))
    ...
    def button_apply_revCal_clicked(self):
        if self.DSM is None or self.offset is None or self.PMat is None or self.rawImgFold is None:
            ...
            end_time = time.monotonic()
            time_revCal = timedelta(seconds=end_time - start_time)
